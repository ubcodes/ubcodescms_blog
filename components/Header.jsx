  ...
  return (
    <div className='container mx-auto px-8 mb-8'>
      ...
      <div className=' md:float-left md:contents'>
        <a href="https://emmanuellaubokabasi.me/" target='_blank' ><span className='md:float-right  mt-10 mb-0 align-middle text-white ml-2 md:ml-4 lg:ml-4 font-semibold cursor-pointer text-xl hover:text-purple-600 transform hover:-translate-y-1 transition duration-500'>Portfolio</span></a>
