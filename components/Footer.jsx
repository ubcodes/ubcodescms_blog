    ...
    <footer className='bg-white-200 text-center mx-auto text-white dark:bg-purple-100 w-full'>
        <div className='container pt-9 mx-auto w-full'>
          ...
          <path
            ...
            <a href="https://www.instagram.com/ubokabasi_/" className='mx-0.5 lg:mx-5 sm:mx-5 text-neutral-800 dark:text-neutral-200  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full p-3 transition duration-400 hover:-translate-y-1'>
            <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-7 w-7"
          fill="currentColor"
          ...
          <path
            ...
            <a href="https://www.linkedin.com/in/emmanuella-etop-essien-b41846227/" className='mx-0.5 lg:mx-5 sm:mx-5 text-neutral-800 dark:text-neutral-200  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full p-3 transition duration-400 hover:-translate-y-1'>
                <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-7 w-7"
          fill="currentColor"
          ...
          <path
            ...
            <a href="https://github.com/UB30-4" className='mx-0.5 lg:mx-5 sm:mx-5 text-neutral-800 dark:text-neutral-200  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full p-3 transition duration-400 hover:-translate-y-1'>
             <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-7 w-7"
          fill="currentColor"
